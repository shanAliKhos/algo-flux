    ...
    <div className="min-h-screen p-6 lg:p-8 space-y-8">
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle>Strategy Overview Dashboard</CardTitle>
              <CardDescription>Manage strategy configurations</CardDescription>
            </div>
            <Button
              variant="outline"
              size="sm"
          ...
          {editingSection === 'strategies' && formData ? (
            <div className="space-y-6">
                  ...
                  <CardContent className="pt-6 space-y-4">
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          value={strategy.icon}
                          onValueChange={(value) => updateStrategy(index, 'icon', value)}
                        >
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            updateStrategy(index, 'status', value as Strategy['status'])
                          }
                        >
                          <SelectTrigger>
                            <SelectValue />
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            updateStrategy(index, 'accuracy', parseInt(e.target.value) || 0)
                          }
                        />
                      </div>
                      <div className="space-y-2">
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            updateStrategy(index, 'confidence', value as Strategy['confidence'])
                          }
                        >
                          <SelectTrigger>
                            <SelectValue />
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          value={strategy.bias}
                          onChange={(e) => updateStrategy(index, 'bias', e.target.value)}
                        />
                      </div>
                      <div className="space-y-2 md:col-span-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => updateStrategyInstruments(index, e.target.value)}
                        />
                      </div>
                      <div className="space-y-2">
                        <Label>Path</Label>
                        <Input
                          value={strategy.path}
                          onChange={(e) => updateStrategy(index, 'path', e.target.value)}
                        />
                      </div>
                    </div>
                    <Button
              ...
              <div className="flex gap-2">
                <Button variant="outline" onClick={addStrategy}>
                  <Plus className="w-4 h-4 mr-2" />
                  Add Strategy
                </Button>
                <Button onClick={handleSave} disabled={updateMutation.isPending}>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {displayData.strategies.map((strategy) => {
